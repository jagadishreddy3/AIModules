        ...
        <div className="p-8 pb-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
             ...
             <div>
                ...
                <p className="text-xs font-bold text-jobflow-text-dim uppercase tracking-widest">JobFlow AI Pipeline</p>
             </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 pt-4 overflow-y-auto custom-scrollbar flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="space-y-2">
               <label className="text-xs font-black uppercase text-jobflow-text-dim tracking-widest flex items-center gap-2 mb-1">
